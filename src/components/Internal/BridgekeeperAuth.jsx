  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (data.success) {
        ...
        setPopupMsg(data.error || 'Wrong! Into the Gorge of Eternal Peril with you!');
    ...
    <div style={styles.wrapper}>
      ...
      {showWrongPopup && (
        <div style={styles.overlay} onClick={() => setShowWrongPopup(false)}>
          <div style={styles.popup} onClick={e => e.stopPropagation()}>
            <img src={wrongAnswerImg} alt="Wrong answer!" style={styles.popupImg} />
            <p style={styles.popupText}>Into the Gorge of Eternal Peril!</p>
            <p style={styles.popupSub}>That is the wrong answer. Try again...</p>
            <button style={styles.popupBtn} onClick={() => setShowWrongPopup(false)}>
              Try Again
            </button>
          </div>
        </div>
      ...
      <div style={styles.pageContainer}>
        <div style={styles.card}>
          <img src={bridgekeeperImg} alt="The Bridgekeeper" style={styles.img} />
          ...
          <p style={styles.riddle}>
            ...
            <br /><br />
            Actually, just one.<br />
            <strong style={{ color: '#fff' }}>What is the secret keyword?</strong>
          </p>
