    ...
    <div className="takeLeap">
      ...
      <div className="AvantGarde-text">
        ...
        <p>
          ...
          chance, and throwing in all we have got and await all that life has in
          store for us. So, open your mind, unbound your thoughts, and let's
          together, Take the leap!.
        </p>
      </div>
    </div>
  );
