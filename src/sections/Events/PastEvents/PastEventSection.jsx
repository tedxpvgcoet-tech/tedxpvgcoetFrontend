...
import punarutthanImg from "../../../assets/backgrounds/Punarutthan-bg.webp"; // Use actual filename
    ...
    <section className="past-event-section">
      <div className="past-event-section-dum">
        <div className="past-event-content">
          ...
          >
            <img src={punarutthanImg} alt="Punarutthan Event" loading="lazy" />
          </div>
          ...
          >
            ...
            <p className="desc">
              “Punarutthan” stands for revival and renewal, drawing from deep
              cultural roots. It invites us to rethink, rebuild, and reimagine a
              better future.
            </p>
            <Link to="/events/Punarutthan" className="see-more">
              See More
            </Link>
          </div>
        </div>
