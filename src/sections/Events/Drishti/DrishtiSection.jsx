...
import gridImage from "../../../assets/backgrounds/Grid.png";
    ...
    <section className="drishti-section">
      <div className="drishti-content">
        ...
        <p className="drishti-text">
          ...
          Drishti is not about what is obvious. It is about what becomes visible
          when we slow down, when we reflect, and when we invite ourselves to
          notice the things that often go unseen—within others and within
          ourselves. It is the moment of pause before we react, the breath we
          take before forming judgment, the space where a new way of thinking
          emerges. When people talk about changing their life, they often speak
          of a moment when something suddenly “clicked,” when they began to look
          at something familiar in an entirely new way. That is Drishti—a quiet
          turning point, an internal shift that can lead to profound external
          change.
        </p>
      </div>
