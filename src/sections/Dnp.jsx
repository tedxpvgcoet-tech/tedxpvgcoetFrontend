    ...
    <section className="dnp-section">
      ...
      <div className="dnp-text" ref={textRef}>
        <p className="dnp-description">
                       Responsible for the event’s physical and visual experience, the DNP Team turns themes into immersive spaces. Through set design, spatial planning, and creative execution, they build the TEDx atmosphere.  </p>
