    ...
    <div className={containerClasses} ref={sectionRef}>
      ...
      <div className={`tedx-text-wrapper ${inView ? "animate" : ""}`}>
        ...
        <div className="tedx-box">
          ...
          <p>
            Pune Vidyarthi Griha's College of Engineering, Technology and Management (PVGCOETM) carries a rich
            culture of education and hosts a plethora of events bringing about
            all-round development of students. The TEDxPVGCOETM (formerly TEDxPVGCOET) event is a prized
