    ...
    <div className={containerClasses} ref={sectionRef}>
      ...
      <div className={`tedx-text-wrapper ${inView ? "animate" : ""}`}>
        ...
        <div className="tedx-box">
          ...
          <p>
            PVG’s College of Engineering and Technology (PVGCOETM) carries a
            rich culture of education and hosts a plethora of events bringing
            about all-round development of students. The TEDxPVGCOETM event is a
            prized gemstone hosted independently by students and faculty members
            under a University TEDx license.This event enables participants from
