    ...
    <section className="editorial-section">
      ...
      <div className="editorial-text">
        <p className="editorial-description">
         The Editorial Team crafts the written voice of TEDxPVGCOET- from theme documents to speaker communications. They refine every word to ensure clarity, consistency, and alignment with the event’s vision.</p>
